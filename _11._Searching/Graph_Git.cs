...
namespace _11._Searching
{
    internal class Graph_Git
    {
        ...
        public void CreateGraph()
        {
            ...
            listGraph1[0].Add(1); // 0 -> 1 
            listGraph1[1].Add(0); // 1 -> 0 Bidirectional (or Undirectional) 
            listGraph1[1].Add(3); // 1 -> 3 
            listGraph1[2].Add(0); // 2 -> 0 
            listGraph1[2].Add(1); // 2 -> 1
            listGraph1[2].Add(4); // 2 -> 4
            listGraph1[3].Add(1); // 3 -> 1
            listGraph1[4].Add(3); // 4 -> 3
