...
namespace Task_DataStructure
{
    ...
    public class PriorityQueue<TElement>
    {
        ...
        public struct Node
        {
            ...
            public int priority { get; set; } // IComparable 을 통해서도 값을 지정하여줄수 있으나, 그렇게 할까..? nvm not yet 
        ...
        {
            Node newNode = new Node // 새로운 값 어서오고 
            {
                element = element,
                priority = priority
            };
        ...
        public void Swap(ref Node first, ref Node second)
        {
            Node temp = first;
            first = second;
            second = temp;
